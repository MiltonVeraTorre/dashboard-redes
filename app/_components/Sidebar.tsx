...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: 'Alertas', path: '/capacity-alerts', icon: 'bell' },
  ...
  const getIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'chart-line':
        return (
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" d="M3 3a1 1 0 000 2h10a1 1 0 100-2H3zm0 4a1 1 0 000 2h6a1 1 0 100-2H3zm0 4a1 1 0 100 2h8a1 1 0 100-2H3zm8-9a1 1 0 00-1 1v8a1 1 0 102 0V3a1 1 0 00-1-1z" clipRule="evenodd"></path>
          </svg>
        );
      case 'gear':
        return (
